    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-6">
          <Link href="/admin/dashboard" className="flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 space-y-3">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button onClick={() => handleAction(r.id, 'active')} disabled={!!processing}
                          className="flex-1 bg-linear-to-r from-orange-500 to-pink-600 text-white py-2.5 rounded-xl text-sm font-bold disabled:opacity-50">
        ...
        {activeTab === 'recommendations' && (
          <div className="space-y-4">
            <div className="bg-linear-to-r from-purple-50 to-blue-50 rounded-2xl p-5 border border-purple-100 mb-4">
            ...
            {recommendations.length === 0 ? (
              ...
              <div key={i} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-center gap-4">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 ${rec.type === 'vendor_ranking' ? 'bg-orange-100' : 'bg-blue-100'}`}>
