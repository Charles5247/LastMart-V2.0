...
export const metadata: Metadata = {
  ...
  description:
    "Join verified vendors selling on LastMart. Open your store in minutes, reach customers across Nigeria, and grow your business with zero listing fees.",
  keywords: [
    "sell online Nigeria",
  ...
  openGraph: {
    title: "Start Selling on LastMart — Nigeria's trusted Local Marketplace",
    description:
      "Join 20+ verified vendors. Open your store free in minutes and reach customers across Nigeria.",
  ...
  twitter: {
    ...
    description: "Join 20+ verified vendors. Open your store free in minutes.",
