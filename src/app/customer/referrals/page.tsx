...
export default function ReferralsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <div className="bg-linear-to-r from-green-500 via-teal-500 to-blue-500 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <Link href="/customer/dashboard" className="flex items-center gap-2 text-white/80 hover:text-white text-sm mb-4 transition-colors w-fit">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {coupons.map((c: any) => (
                  <div key={c.id} className={`bg-white rounded-2xl shadow-sm overflow-hidden border ${
                    ...
                    {/* Coupon header */}
                    <div className="bg-linear-to-r from-orange-500 to-pink-500 px-5 py-3 flex items-center justify-between">
                      <div>
