...
import { Users, Store, Package, ShoppingBag, DollarSign, TrendingUp, BarChart2, ArrowRight, AlertTriangle, CheckCircle, Clock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { href: '/dashboard/admin/orders', icon: ShoppingBag, label: 'Monitor Orders', badge: 0, color: 'from-blue-400 to-blue-600' },
            { href: '/dashboard/admin/analytics', icon: TrendingUp, label: 'Analytics', badge: 0, color: 'from-green-400 to-green-600' },
            { href: '/dashboard/admin/vendors', icon: Users, label: 'Users & Vendors', badge: 0, color: 'from-orange-400 to-orange-600' },
          ].map(link => (
            <Link key={link.href} href={link.href} className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center gap-3 hover:shadow-md transition-shadow border border-gray-100 relative">
              <div className={`w-14 h-14 bg-gradient-to-br ${link.color} rounded-2xl flex items-center justify-center shadow-lg`}>
