      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/dashboard/rider/deliveries" className="text-orange-500 text-sm font-semibold flex items-center gap-1 hover:underline">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { href: '/dashboard/rider/earnings', label: 'Earnings & Payouts', icon: Wallet, color: 'bg-green-500' },
            { href: '/dashboard/rider/deliveries', label: 'All Deliveries', icon: Package, color: 'bg-blue-500' },
            { href: '/dashboard/rider/profile', label: 'My Profile', icon: User, color: 'bg-purple-500' },
