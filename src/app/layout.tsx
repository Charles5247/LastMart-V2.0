...
export const metadata: Metadata = {
  ...
  keywords: 'marketplace, local shopping, Nigeria, Lagos, vendors, ecommerce, buy online Nigeria',
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL ?? 'https://lastmart.com'),
  openGraph: {
    siteName: 'LastMart',
    type:     'website',
    locale:   'en_NG',
