    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          <Link href="/vendor/dashboard" className="p-2 rounded-xl hover:bg-gray-100"><ArrowLeft className="w-5 h-5" /></Link>
          <div>
        ...
        {/* Current Plan Banner */}
        <div className="bg-linear-to-r from-orange-500 to-orange-600 text-white rounded-2xl p-5 mb-8 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {TIERS.map((tier) => (
            <div key={tier.id}
              className={`bg-white rounded-2xl border-2 shadow-sm overflow-hidden transition-shadow hover:shadow-md flex flex-col ${
                tier.color
