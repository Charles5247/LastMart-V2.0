                ...
                {nextStatus[order.status] && (
                  <div className="flex gap-3 pt-3 border-t border-gray-100 flex-wrap">
                    <button
                      ...
                      className="flex items-center gap-2 bg-linear-to-r from-orange-500 to-pink-600 text-white px-5 py-2.5 rounded-xl font-medium text-sm hover:opacity-90 disabled:opacity-50"
                    >
