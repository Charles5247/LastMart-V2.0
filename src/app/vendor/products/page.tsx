      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <Link href="/vendor/dashboard" className="w-10 h-10 rounded-xl bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-50 shadow-sm">
          ...
          <button onClick={openCreate} className="flex items-center gap-2 bg-linear-to-r from-orange-500 to-pink-600 text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:opacity-90 transition-opacity shadow-lg">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={saveProduct} disabled={saving}
                  className="flex-1 bg-linear-to-r from-orange-500 to-pink-600 text-white py-3 rounded-xl font-bold hover:opacity-90 disabled:opacity-50">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 truncate max-w-55">{vettingProduct.name}</p>
                </div>
              </div>
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button onClick={submitForVetting} disabled={submittingVet}
                  className="flex-1 bg-linear-to-r from-teal-500 to-green-600 text-white py-3 rounded-xl font-bold hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2">
