...
export default function VendorQRPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <div className="bg-linear-to-r from-purple-600 via-pink-600 to-orange-500 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <Link href="/vendor/dashboard" className="flex items-center gap-2 text-white/80 hover:text-white text-sm mb-4 transition-colors w-fit">
