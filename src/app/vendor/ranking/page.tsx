    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-linear-to-r from-purple-600 via-pink-600 to-orange-500 py-10">
        <div className="max-w-5xl mx-auto px-4">
          <Link href="/vendor/dashboard" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-4 text-sm">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {myRankings.filter(r => r.status === 'active').map(r => (
                <div key={r.id} className="flex items-center gap-4 bg-linear-to-r from-orange-50 to-pink-50 rounded-xl p-4 border border-orange-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {displayPackages.map(pkg => (
            <div key={pkg.id}
              ...
              className={`bg-white rounded-2xl shadow-sm border cursor-pointer transition-all hover:shadow-md hover:-translate-y-1 p-5 flex flex-col ${
                ...
                <div className='flex-1'>
                  {pkg.priority_level >= 3 && (
                    <div className="bg-linear-to-r from-yellow-400 to-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full inline-block mb-3">
                      ⭐ Most Popular
                    </div>
                  )}
              ...
              <button className="w-full bg-linear-to-r from-orange-500 to-pink-600 text-white py-2.5 rounded-xl text-sm font-bold">
                Apply Now
              </button>
            </div>
          ))}
          ...
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={handleApply} disabled={applying}
                className="flex-1 bg-linear-to-r from-orange-500 to-pink-600 text-white py-3 rounded-xl font-bold text-sm disabled:opacity-50">
