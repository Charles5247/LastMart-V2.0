...
const METRICS = [
  ...
  { icon: CheckCircle, value: '1,200+',    label: 'Verified Vendors', color: 'text-green-600' },
  { icon: Package,     value: '85,000+',   label: 'Products Listed',  color: 'text-purple-600' },
  { icon: TrendingUp,  value: '200+ Cities', label: 'Cities Covered', color: 'text-orange-600' },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-orange-500/40 py-2">
            {METRICS.map(({ icon: Icon, value, label }) => (
              <div key={label} className="flex items-center justify-center gap-2 px-4 py-2">
        ...
        <div className="panel">
          <div className="section-header">
            <span className="section-title flex items-center gap-2">
              ...
              Top Vendors in <span className="text-orange-500 ml-1">{location.city}</span>
            </span>
