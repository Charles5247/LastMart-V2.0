...
/* ─── Metrics ────────────────────────────────────────────────────────────── */
const METRICS = [
  { value: "10+", label: "Active Customers", icon: Users },
  { value: "20+", label: "Verified Vendors", icon: Store },
  { value: "2+", label: "Cities Covered", icon: MapPin },
  { value: "₦2M+", label: "Total Sales Volume", icon: TrendingUp },
];
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: "Reach verified real customers in your city and beyond. Get real-time order notifications and analytics to scale your business.",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <span className="inline-flex items-center gap-1.5 bg-orange-500/20 text-orange-400 text-xs font-bold px-3 py-1.5 rounded-full mb-6 border border-orange-500/30">
                  <Zap className="w-3 h-3" /> Join 20+ Verified Vendors
                </span>
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-lg">
                  ...
                  <strong className="text-white">50+ active customers</strong>{" "}
