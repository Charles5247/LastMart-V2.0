    ...
    <footer className="bg-gray-900 text-gray-400">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-5">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Subscribe for exclusive offers, new vendor alerts, and local
                deals.
              </p>
            </div>
            <form
            ...
            >
              ...
              <button
                type="submit"
                className="bg-orange-500 hover:bg-orange-600 text-white font-semibold text-sm px-5 py-2.5 rounded-lg transition-colors flex items-center gap-1.5 whitespace-nowrap"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-5 max-w-xs">
              Nigeria&apos;s fastest local marketplace. Connect with verified
              vendors in your city and receive your orders within 48 hours.
            </p>
            <div className="flex gap-2">
              {[
                ...
                <a
                  key={i}
                  href={href}
                  className="w-9 h-9 bg-gray-800 hover:bg-orange-500 rounded-lg flex items-center justify-center transition-all hover:-translate-y-0.5"
                >
            ...
            <ul className="space-y-2.5">
              {LINKS.shop.map(([label, href]) => (
                <li key={label}>
                  <Link
                    href={href}
                    className="text-sm hover:text-orange-400 transition-colors hover:translate-x-0.5 inline-block"
                  >
                    {label}
                  </Link>
                </li>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <p>
            © {new Date().getFullYear()} LastMart Technologies Ltd. All rights
            reserved.
          </p>
          <p>
            Developed by{" "}
            <a href="https://caxie-technologies.netlify.app">
